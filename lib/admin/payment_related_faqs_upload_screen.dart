...
class PaymentRelatedFaqsUploadScreen extends StatefulWidget {
  const PaymentRelatedFaqsUploadScreen({super.key});

  @override
  State<PaymentRelatedFaqsUploadScreen> createState() => _PaymentRelatedFaqsUploadScreenState();
}

class _PaymentRelatedFaqsUploadScreenState extends State<PaymentRelatedFaqsUploadScreen> {
    ...
    try {
      ...
      if (_uploadedImages.isNotEmpty) {
        ...
        for (File image in _uploadedImages) {
          ...
          FirebaseStorage.instance.ref().child('payment_related_images/$fileName');
