...
class LoginRelatedFaqsUploadScreen extends StatefulWidget {
  const LoginRelatedFaqsUploadScreen({super.key});

  @override
  State<LoginRelatedFaqsUploadScreen> createState() => _LoginRelatedFaqsUploadScreenState();
}

class _LoginRelatedFaqsUploadScreenState extends State<LoginRelatedFaqsUploadScreen> {
    ...
    try {
      ...
      if (_uploadedImages.isNotEmpty) {
        ...
        for (File image in _uploadedImages) {
          ...
          FirebaseStorage.instance.ref().child('login_related_images/$fileName');
