...
class PickupRelatedFaqsUploadScreen extends StatefulWidget {
  const PickupRelatedFaqsUploadScreen({super.key});

  @override
  State<PickupRelatedFaqsUploadScreen> createState() => _PickupRelatedFaqsUploadScreenState();
}

class _PickupRelatedFaqsUploadScreenState extends State<PickupRelatedFaqsUploadScreen> {
    ...
    try {
      ...
      if (_uploadedImages.isNotEmpty) {
        ...
        for (File image in _uploadedImages) {
          ...
          FirebaseStorage.instance.ref().child('pickup_related_images/$fileName');
