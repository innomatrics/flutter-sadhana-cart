...
class ReturnRelatedFaqsUploadScreen extends StatefulWidget {
  const ReturnRelatedFaqsUploadScreen({super.key});

  @override
  State<ReturnRelatedFaqsUploadScreen> createState() => _ReturnRelatedFaqsUploadScreenState();
}

class _ReturnRelatedFaqsUploadScreenState extends State<ReturnRelatedFaqsUploadScreen> {
    ...
    try {
      ...
      if (_uploadedImages.isNotEmpty) {
        ...
        for (File image in _uploadedImages) {
          ...
          FirebaseStorage.instance.ref().child('return_related_images/$fileName');
