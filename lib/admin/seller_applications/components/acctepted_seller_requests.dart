...
class AccteptedSellerRequests extends StatelessWidget {
  const AccteptedSellerRequests({super.key});

  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<GetSellerApplicationProvider>(context);
    final length = provider.filterAccepted.length;
    return Scaffold(
        ...
        builder: (context, value, child) {
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              final application = value.filterAccepted[index];
              return ListTile(
