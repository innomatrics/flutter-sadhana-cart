...
//     );
//   }
// }   everything is good but expected delivery is missed
...
// withspaces also you can upload fields
  ...
  //       List<String> videoUrls = await _uploadFiles(_selectedVideos, 'item_videos');
  //
  //       // Convert product details list to a map and trim values
  //       Map<String, dynamic> productDetailsMap = {};
  //       for (var detail in _productDetailsList) {
  //         if (detail['key'] != null && detail['value'] != null) {
  //           productDetailsMap[detail['key']!.trim()] = detail['value']!.trim();
  //         }
  //       }
  //
  //       final productRef = FirebaseFirestore.instance
  ...
  //         'isShowCashOnDelivery': selectedShowCashonDelivery!.trim(),
