...
class PickupFaqsAnswers extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const PickupFaqsAnswers({super.key, required this.faqId});

  @override
  _PickupFaqsAnswersState createState() => _PickupFaqsAnswersState();
}

class _PickupFaqsAnswersState extends State<PickupFaqsAnswers> {
