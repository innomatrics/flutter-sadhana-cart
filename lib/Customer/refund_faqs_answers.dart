...
class RefundFaqsAnswers extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const RefundFaqsAnswers({super.key, required this.faqId});

  @override
  _RefundFaqsAnswersState createState() => _RefundFaqsAnswersState();
}

class _RefundFaqsAnswersState extends State<RefundFaqsAnswers> {
