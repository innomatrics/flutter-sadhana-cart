...
class ReturnFaqsAnswers extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const ReturnFaqsAnswers({super.key, required this.faqId});

  @override
  _ReturnFaqsAnswersState createState() => _ReturnFaqsAnswersState();
}

class _ReturnFaqsAnswersState extends State<ReturnFaqsAnswers> {
