...
class TwoWheelerFaqsAnswers extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const TwoWheelerFaqsAnswers({super.key, required this.faqId});

  @override
  _TwoWheelerFaqsAnswersState createState() => _TwoWheelerFaqsAnswersState();
}

class _TwoWheelerFaqsAnswersState extends State<TwoWheelerFaqsAnswers> {
