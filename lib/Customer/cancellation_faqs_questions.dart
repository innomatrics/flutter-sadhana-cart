...
import 'package:sadhana_cart/Customer/cancellation_faqs_answers.dart';

class CancellationFaqsQuestions extends StatelessWidget {
  const CancellationFaqsQuestions({super.key});
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CancellationFaqsAnswers(faqId: doc.id),
                        ),
                      );
                    },
                  ),
