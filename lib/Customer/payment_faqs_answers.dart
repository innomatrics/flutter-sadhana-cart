...
class PaymentFaqsAnswers extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const PaymentFaqsAnswers({super.key, required this.faqId});

  @override
  _PaymentFaqsAnswersState createState() => _PaymentFaqsAnswersState();
}

class _PaymentFaqsAnswersState extends State<PaymentFaqsAnswers> {
