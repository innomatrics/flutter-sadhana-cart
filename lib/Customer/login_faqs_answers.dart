...
class LoginFaqsAnswers extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const LoginFaqsAnswers({super.key, required this.faqId});

  @override
  _LoginFaqsAnswersState createState() => _LoginFaqsAnswersState();
}

class _LoginFaqsAnswersState extends State<LoginFaqsAnswers> {
