...
class CancellationFaqsAnswers extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const CancellationFaqsAnswers({super.key, required this.faqId});

  @override
  _CancellationFaqsAnswersState createState() => _CancellationFaqsAnswersState();
}

class _CancellationFaqsAnswersState extends State<CancellationFaqsAnswers> {
