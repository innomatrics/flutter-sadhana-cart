...
class GroceryFaqsAnswers extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const GroceryFaqsAnswers({super.key, required this.faqId});

  @override
  _GroceryFaqsAnswersState createState() => _GroceryFaqsAnswersState();
}

class _GroceryFaqsAnswersState extends State<GroceryFaqsAnswers> {
