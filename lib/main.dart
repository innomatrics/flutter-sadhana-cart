...
// import 'Customer/role_selection.dart';
// import 'customer_seller_welcome_screen.dart';
...
//
//       home: const CustomerSellerWelcomeScreen(),
//
...
import 'package:sadhana_cart/Web/Customer/customer_splash_screen.dart';
...
import 'package:sadhana_cart/admin/provider/get_seller_application_provider.dart';
import 'package:sadhana_cart/admin/provider/product_provider.dart';
import 'package:sadhana_cart/webapp.dart';
import 'package:sadhana_cart/webapp_app_banner_image_upload.dart';
import 'Customer/role_selection.dart';
import 'Web/Customer/customer_profile_screen.dart';
import 'adm_webapp_pannel_drawer.dart';
import 'customer_seller_welcome_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: _getHomeScreen(),
      routes: {
        '/become': (context) => const WebSellerSignInScreen(),
        '/privacy': (context) => const WebPrivacyPolicyScreen(),
        '/about': (context) => const WebAboutUsScreen(),
        '/contact': (context) => const WebShippingPolicyScreen(),
        '/return-policy': (context) => const WebReturnPolicyScreen(),
        '/shipping-policy': (context) => const WebShippingPolicyScreen(),
        '/terms': (context) => const WebTermsAndConditionsScreen(),
        '/orders': (context) => const WebMyOrdersScreen(),
        '/chat': (context) => const WebChatScreen(),
        '/faqs': (context) => const WebFAQsScreen(),
...
//     if (kIsWeb) {
//       // Return mobile web or desktop web based on detection
//       return isMobileWeb() ? const SplashScreen() : const WebSellerSignInScreen(); // Adjust as needed
//     } else if (defaultTargetPlatform == TargetPlatform.android ||
//         defaultTargetPlatform == TargetPlatform.iOS) {
//       // Return mobile app screens
