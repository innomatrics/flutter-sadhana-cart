...
class UploadCooldrinksItemsScreen extends StatefulWidget {
  const UploadCooldrinksItemsScreen({super.key});

  @override
  _UploadCooldrinksItemsScreenState createState() =>
      _UploadCooldrinksItemsScreenState();
}

class _UploadCooldrinksItemsScreenState extends State<UploadCooldrinksItemsScreen> {
