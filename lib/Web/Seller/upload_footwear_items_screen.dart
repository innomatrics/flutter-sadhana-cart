...
class UploadFootwearItemsScreen extends StatefulWidget {
  const UploadFootwearItemsScreen({super.key});

  @override
  _UploadFootwearItemsScreenState createState() =>
      _UploadFootwearItemsScreenState();
}

class _UploadFootwearItemsScreenState extends State<UploadFootwearItemsScreen> {
    ...
    if (_formKey.currentState!.validate() && _colors.isNotEmpty) {
      ...
      try {
        ...
        await FirebaseFirestore.instance
            ...
            .collection(
                'Footwear') // Creating a 'Clothings' subcollection for the seller
            .add({
          'name': _name,
          'category': _category,
          'shop Name': _shopName,
