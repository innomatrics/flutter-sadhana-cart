...
class UploadFurnitureItemsScreen extends StatefulWidget {
  const UploadFurnitureItemsScreen({super.key});

  @override
  _UploadFurnitureItemsScreenState createState() =>
      _UploadFurnitureItemsScreenState();
}

class _UploadFurnitureItemsScreenState extends State<UploadFurnitureItemsScreen> {
