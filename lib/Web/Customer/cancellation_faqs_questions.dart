...
import 'package:sadhana_cart/Web/Customer/cancellation_faqs_answers.dart';

class WebCancellationFaqsQuestions extends StatelessWidget {
  const WebCancellationFaqsQuestions({super.key});
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => WebCancellationFaqsAnswers(faqId: doc.id),
                        ),
                      );
                    },
                  ),
