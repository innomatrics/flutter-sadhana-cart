...
class WebCancellationFaqsAnswers extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const WebCancellationFaqsAnswers({super.key, required this.faqId});

  @override
  _WebCancellationFaqsAnswersState createState() => _WebCancellationFaqsAnswersState();
}

class _WebCancellationFaqsAnswersState extends State<WebCancellationFaqsAnswers> {
