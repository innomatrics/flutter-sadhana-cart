...
class WebReturnFaqsAnswers extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const WebReturnFaqsAnswers({super.key, required this.faqId});

  @override
  _WebReturnFaqsAnswersState createState() => _WebReturnFaqsAnswersState();
}

class _WebReturnFaqsAnswersState extends State<WebReturnFaqsAnswers> {
