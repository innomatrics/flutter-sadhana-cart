...
import 'package:sadhana_cart/Customer/refund_faqs_answers.dart';
import 'package:sadhana_cart/Web/Customer/refund_faqs_answers.dart';

class WebRefundRelatedFaqs extends StatelessWidget {
  const WebRefundRelatedFaqs({super.key});
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => WebRefundFaqsAnswers(faqId: doc.id),
                        ),
                      );
                    },
                  ),
