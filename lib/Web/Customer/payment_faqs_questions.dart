...
import 'package:sadhana_cart/Customer/payment_faqs_answers.dart';
import 'package:sadhana_cart/Web/Customer/payment_faqs_answers.dart';

class WebPaymentFaqsQuestions extends StatelessWidget {
  const WebPaymentFaqsQuestions({super.key});
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => WebPaymentFaqsAnswers(faqId: doc.id),
                        ),
                      );
                    },
                  ),
