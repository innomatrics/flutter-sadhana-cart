...
class WebFAQDetailPage extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const WebFAQDetailPage({super.key, required this.faqId});

  @override
  _WebFAQDetailPageState createState() => _WebFAQDetailPageState();
}

class _WebFAQDetailPageState extends State<WebFAQDetailPage> {
