...
import 'package:sadhana_cart/Customer/grocery_faqs_answers.dart';
import 'package:sadhana_cart/Web/Customer/grocery_faqs_answers.dart';

class WebGroceryFaqsQuestions extends StatelessWidget {
  const WebGroceryFaqsQuestions({super.key});
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => WebGroceryFaqsAnswers(faqId: doc.id),
                        ),
                      );
                    },
                  ),
