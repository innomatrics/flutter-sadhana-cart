...
class WebLoginFaqsAnswers extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const WebLoginFaqsAnswers({super.key, required this.faqId});

  @override
  _WebLoginFaqsAnswersState createState() => _WebLoginFaqsAnswersState();
}

class _WebLoginFaqsAnswersState extends State<WebLoginFaqsAnswers> {
