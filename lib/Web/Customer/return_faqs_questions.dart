...
import 'package:sadhana_cart/Customer/return_faqs_answers.dart';
import 'package:sadhana_cart/Web/Customer/return_faqs_answers.dart';

class WebReturnFaqsQuestions extends StatelessWidget {
  const WebReturnFaqsQuestions({super.key});
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => WebReturnFaqsAnswers(faqId: doc.id),
                        ),
                      );
                    },
                  ),
