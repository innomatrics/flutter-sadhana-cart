...
class WebRefundFaqsAnswers extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const WebRefundFaqsAnswers({super.key, required this.faqId});

  @override
  _WebRefundFaqsAnswersState createState() => _WebRefundFaqsAnswersState();
}

class _WebRefundFaqsAnswersState extends State<WebRefundFaqsAnswers> {
