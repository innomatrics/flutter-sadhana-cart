...
class WebTwoWheelerFaqsAnswers extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const WebTwoWheelerFaqsAnswers({super.key, required this.faqId});

  @override
  _WebTwoWheelerFaqsAnswersState createState() => _WebTwoWheelerFaqsAnswersState();
}

class _WebTwoWheelerFaqsAnswersState extends State<WebTwoWheelerFaqsAnswers> {
