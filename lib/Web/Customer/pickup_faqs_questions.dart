...
import 'package:sadhana_cart/Customer/pickup_faqs_answers.dart';
import 'package:sadhana_cart/Web/Customer/pickup_faqs_answers.dart';

class WebPickupFaqsQuestions extends StatelessWidget {
  const WebPickupFaqsQuestions({super.key});
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => WebPickupFaqsAnswers(faqId: doc.id),
                        ),
                      );
                    },
                  ),
