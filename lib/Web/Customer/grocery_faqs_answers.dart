...
class WebGroceryFaqsAnswers extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const WebGroceryFaqsAnswers({super.key, required this.faqId});

  @override
  _WebGroceryFaqsAnswersState createState() => _WebGroceryFaqsAnswersState();
}

class _WebGroceryFaqsAnswersState extends State<WebGroceryFaqsAnswers> {
