...
import 'package:sadhana_cart/Customer/login_faqs_answers.dart';
import 'package:sadhana_cart/Web/Customer/login_faqs_answers.dart';

class WebLoginFaqsQuestions extends StatelessWidget {
  const WebLoginFaqsQuestions({super.key});
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => WebLoginFaqsAnswers(faqId: doc.id),
                        ),
                      );
                    },
                  ),
