...
class WebPickupFaqsAnswers extends StatefulWidget {
  final String faqId; // ID of the FAQ document

  const WebPickupFaqsAnswers({super.key, required this.faqId});

  @override
  _WebPickupFaqsAnswersState createState() => _WebPickupFaqsAnswersState();
}

class _WebPickupFaqsAnswersState extends State<WebPickupFaqsAnswers> {
