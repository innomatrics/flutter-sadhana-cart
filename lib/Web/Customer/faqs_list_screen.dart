...
import 'package:sadhana_cart/Customer/faq_details.dart';
import 'package:sadhana_cart/Web/Customer/faq_details.dart';

class WebFAQListPage extends StatelessWidget {
  const WebFAQListPage({super.key});
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => WebFAQDetailPage(faqId: doc.id),
                        ),
                      );
                    },
                  ),
