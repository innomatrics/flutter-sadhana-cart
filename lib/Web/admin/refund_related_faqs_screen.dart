...
class RefundRelatedFaqsUploadScreen extends StatefulWidget {
  const RefundRelatedFaqsUploadScreen({super.key});

  @override
  State<RefundRelatedFaqsUploadScreen> createState() => _RefundRelatedFaqsUploadScreenState();
}

class _RefundRelatedFaqsUploadScreenState extends State<RefundRelatedFaqsUploadScreen> {
    ...
    try {
      ...
      if (_uploadedImages.isNotEmpty) {
        ...
        for (File image in _uploadedImages) {
          ...
          FirebaseStorage.instance.ref().child('refund_related_images/$fileName');
