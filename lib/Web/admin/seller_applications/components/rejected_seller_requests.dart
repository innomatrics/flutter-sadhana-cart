...
class RejectedSellerRequests extends StatelessWidget {
  const RejectedSellerRequests({super.key});

  @override
  Widget build(BuildContext context) {
    final provider = Provider.of<GetSellerApplicationProvider>(context);
    final length = provider.filterRejected.length;
    return Scaffold(
        ...
        builder: (context, value, child) {
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              final application = value.filterRejected[index];
              return ListTile(
